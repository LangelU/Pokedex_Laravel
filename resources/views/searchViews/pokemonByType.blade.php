...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="notifications.js">
...
<body>
    ...
    <form action="{{route('lookPokemon')}}" method="GET">        
      ...
      <button>Buscar</button>
       ...
       <div align="center" class="home">
          <a href="{{route('pokemonLibrary')}}"><img src="img\wallpapers\back_arrow.png" title="Regresar"></a>
       </div>
  </section>
  <div class="b_filter">
  ...
  <!------------------- Show library pokémon filtered by type ----------------------------->
  ...
  <div>
    @foreach ($filtered as $item)
      <div class="card">
        ...
        <div align="center">
          <a href="{{route('pokemonDetails', $item->p_number)}}"><img src="{{asset('img/pokemon/'.$item->p_number.'.png')}}"></a>
        </div>
        <br>
        <label> {{$item->p_type}} {{$item->s_type}} </label>
      </div>
   @endforeach
  </div>
